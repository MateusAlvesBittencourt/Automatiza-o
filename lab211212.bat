cmd /c wmic product where name="Palisade DecisionTools Suite 8.2" call uninstall
start /WAIT DTSUIT~1.EXE /s /v/qn /v"DTOPSHORTCUTS=0"
xcopy PALISA~1.LIC "C:\Program Files (x86)\Palisade\System" /y /i /q
